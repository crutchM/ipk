...
func (t TestPostgres) getBlocks(tId int) ([]model.Block, error) {
...
func (t TestPostgres) getQuestions(bId int) ([]model.Question, error) {
	var qIds []int
...
func (t TestPostgres) GetTest(id int) (model.Test, error) {
	var test model.Test
...
func (t TestPostgres) CreateTest(test model.Test) (int, error) {
	var testId int
